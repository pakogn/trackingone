...
import com.spyc.trackingone.data.network.model.ApiError;
...
public class BasePresenter<V extends MvpViewContract> implements MvpPresenter<V> {
        ...
        try {
            ...
            switch (error.getErrorCode()) {
                ...
                case HttpsURLConnection.HTTP_FORBIDDEN:
                    ...
                    getMvpView().onError("Inicia sesión con credenciales válidas.");
